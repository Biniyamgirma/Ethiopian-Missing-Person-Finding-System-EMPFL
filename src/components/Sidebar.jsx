...
const navItems = [
  ...
  { href: "/manage-posts", label: "Manage Post", icon: LayoutDashboard }, 
  { href: "/criminals", label: "Criminals", icon: ShieldAlert },
  { href: "/police-stations", label: "Manage Police Station", icon: Building }, 
  { href: "/messaging", label: "Messaging", icon: MessageCircle },
  // { href: "/search", label: "Search By Image", icon: Image }, 
    ...
    >
      <div className="p-4 border-b dark:border-gray-700 flex items-center justify-center h-16">
        <Link to="/" className="flex items-center space-x-2" title="APC Home">
          <img
            src="./public/image/fedral.png" // Assuming fedral.jpg is in public/images/
            alt="APC Logo"
          ...
          />
          {!collapsed && <span className="text-xl font-semibold">APF</span>}
        </Link>
      </div>
