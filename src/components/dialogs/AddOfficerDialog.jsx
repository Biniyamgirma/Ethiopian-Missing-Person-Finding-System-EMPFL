        ...
        <form onSubmit={handleSubmit} className="space-y-6 p-4 pr-2 max-h-[70vh] overflow-y-auto custom-scrollbar"> {/* Added custom-scrollbar if needed */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="add-lastName" name="lastName" value={newPoliceOfficer.lastName} onChange={handleInputChange} placeholder={t('lastNamePlaceholder')} required className="mt-1 bg-white dark:bg-gray-700/50 dark:text-gray-100 dark:border-gray-600 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 placeholder-gray-400 dark:placeholder-gray-500" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="add-phoneNumber" className="text-sm font-medium text-gray-700 dark:text-gray-300">{t('phoneNumber')}</Label>
              <Input id="add-phoneNumber" name="phoneNumber" type="tel" value={newPoliceOfficer.phoneNumber} onChange={handleInputChange} placeholder={t('phoneNumberPlaceholder')} required className="mt-1 bg-white dark:bg-gray-700/50 dark:text-gray-100 dark:border-gray-600 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 placeholder-gray-400 dark:placeholder-gray-500" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="add-birthDate" name="birthDate" type="date" value={newPoliceOfficer.birthDate} onChange={handleInputChange} required className="mt-1 bg-white dark:bg-gray-700/50 dark:text-gray-100 dark:border-gray-600 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="add-rank" name="rank" value={newPoliceOfficer.rank} onChange={handleInputChange} placeholder={t('rankPlaceholder')} required className="mt-1 bg-white dark:bg-gray-700/50 dark:text-gray-100 dark:border-gray-600 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 placeholder-gray-400 dark:placeholder-gray-500" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="add-status" className="text-sm font-medium text-gray-700 dark:text-gray-300">{t('status')}</Label>
                <select id="add-status" name="status" value={newPoliceOfficer.status || 'Active'} onChange={handleInputChange} required className="flex h-10 w-full rounded-md border border-input bg-white dark:bg-gray-700/50 dark:text-gray-100 dark:border-gray-600 px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring dark:focus-visible:ring-blue-400 focus-visible:ring-offset-2 dark:focus-visible:border-blue-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="add-password" name="password" type="password" value={newPoliceOfficer.password} onChange={handleInputChange} placeholder={t('passwordPlaceholder', 'Enter password')} required className="mt-1 bg-white dark:bg-gray-700/50 dark:text-gray-100 dark:border-gray-600 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 placeholder-gray-400 dark:placeholder-gray-500" />
            </div>
            <div className="space-y-2">
              ...
              <select id="add-systemRole" name="systemRole" value={newPoliceOfficer.systemRole} onChange={handleInputChange} required className="flex h-10 w-full rounded-md border border-input bg-white dark:bg-gray-700/50 dark:text-gray-100 dark:border-gray-600 px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring dark:focus-visible:ring-blue-400 focus-visible:ring-offset-2 dark:focus-visible:border-blue-400">
          ...
          <div className="space-y-2">
            ...
            <Input id="add-policeStationId" name="policeStationId" value={newPoliceOfficer.policeStationId} onChange={handleInputChange} placeholder={t('policeStationIdPlaceholder', 'Enter police station ID')} required 
          ...
          <div className="space-y-2">
            ...
            {newPoliceOfficer.image && typeof newPoliceOfficer.image === 'object' && (
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Selected: {newPoliceOfficer.image.name}</p>
            )}
          </div>
