...
const MOCK_STATION_LOGO_PATH = "./public/image/fedral.png";

export default function Settings() {
  const { darkMode: isDarkMode, toggleDarkMode,language, changeLanguage} = useAppContext(); 
  ...
  return (
     ...
     <div className="space-y-8 ">
      <h1 className="text-2xl font-bold dark:text-[foreground]">{t('setting')}</h1>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                {!isLoading && !fetchError && (
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="middleName">{t('middleName') || 'Middle Name'}</Label> {/* Added fallback for t function */}
                    <Input 
                      id="middleName" 
                      name="middleName" 
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="policeOfficerId">{t('policeOfficerId') || 'Police Officer ID'}</Label> {/* Added fallback */}
                    <Input 
                      id="policeOfficerId" 
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      {
                       t('Active', officerData.status || 'Unknown')}
                    </div>
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="policeOfficerPhoneNumber">{t('phoneNumber') || 'Phone Number'}</Label> {/* Added fallback */}
                    <Input 
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="policeOfficerGender">{t('gender') || 'Gender'}</Label> {/* Added fallback */}
                    <Input 
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="birthDate">{t('birthDate') || 'Birth Date'}</Label> {/* Added fallback */}
                    <Input 
                      id="birthDate" 
                      name="birthDate" 
            ...
            <Card >
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <Button onClick={savePasswordChanges} >{t('savePasswordChanges')}</Button>
                </div>
              </CardContent>
            </Card>
          </div>
            ...
            <Card >
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <Label htmlFor="isDarkMode">{t('darkMode')}</Label>
